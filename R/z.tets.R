...
#' Plot
#'
#' This function depictes the p-value area for a object with class \code{htest}.
#'
#' \code{plot} will produce a graph with the p-value of the test.
#'
...
#' res
#' plot(res, col='blue', shade.col='blue')
#'
