...
<center>$\mu=$ *True average life span today (years)*</center>
...
>>>>>>> fecf6af47c634511d31bcf0e96d9554961196cd4
...
<center>$\mu=$ *True average DCP value for a certain type of pavement*</center>
...
```{r, fig.width=6, fig.height=3.5, fig.align='center'}
x<-c(14.1,14.5,15.5,16.0,16.0,16.7,16.9,17.1,17.5,17.8,17.8,18.1,18.2,18.3,18.3,19.0, 19.2,19.4,20.0,20.0,20.8,20.8,21.0,21.5,23.5,27.5,27.5,28.0,28.3,30.0,30.0,31.6,31.7, 31.7,32.5,33.5,33.9,35.0,35.0,35.0,36.7,40.0,40.0,41.3,41.7,47.5,50.0,51.0,51.8,54.4,
55.0,57.0)
...
```{r, fig.width=6, fig.height=3.5, fig.align='center'}
<<<<<<< HEAD
test8 <- var_test(varx=2766.76, nx=28, vary=7089.64, ny=26, null.value = 1, alternative='less',conf.level=0.99)
test8
